...
Source-available WhatsApp bot built on [Baileys](https://github.com/WhiskeySockets/Baileys) **7.0.0-rc13** (N-SAL v1.0 — derivative of the MIT-licensed X-Asena).
...
| `STICKER_PACKNAME` | `Onyx` | Default sticker pack name |
| `STICKER_AUTHOR` | `Onyx` | Default sticker author |
...
# DATABASE_URL=postgresql://user:pass@host:5432/onyxcore
...
2. After connect, the bot creates a group named **`ONYX UTILITY CORE · System`** (or `BOT_NAME` + ` · System`) and adds the owner.
...
[N-SAL v1.0 — Nero Source Available License](LICENSE).
Derivative of [X-Asena](https://github.com/Neeraj-x0/X-Asena) (MIT — see LICENSE
